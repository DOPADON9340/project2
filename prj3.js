...
function getAllvegetableData(){
    const vegetableArr = foodOriginalData[0].filter(
        item => item.category === "Vegetable");
    console.log(vegetableArr);
}
function getAllFruitData(){
    const FruitArr = foodOriginalData[0].filter(
        item => item.category === "Fruit");
    console.log(FruitArr);
}
function getAllProtienData(){
    const ProtienArr = foodOriginalData[0].filter(
        item => item.category === "Protein");
    console.log(ProtienArr);
}
function getAllNutsData(){
    const NutsArr = foodOriginalData[0].filter(
        item => item.category === "Nuts");
    console.log(NutsArr);
}
function getAllGrainsData(){
    const GrainsArr = foodOriginalData[0].filter(
        item => item.category === "Grain");
    console.log(GrainsArr);
}
function getAllDairyData(){
    const DairyArr = foodOriginalData[0].filter(
        item => item.category === "Dairy");
    console.log(DairyArr);
}
function caloriegreaterthan100(){
    const calorieArr = foodOriginalData[0].filter(
        item=> item.calorie > 100);
    console.log(calorieArr);
}
function calorielessthan100(){
    const calorieArr = foodOriginalData[0].filter(
        item=> item.calorie < 100);
    console.log(calorieArr);
}
function HighestProtienContentToLowest(){
    const decendingArr = foodOriginalData[0].slice().sort(
        (a,b) =>b.protiens - a.protiens);
    console.log(decendingArr)    
}
function LowestCabContentToHighest(){
    const ascendingArr = foodOriginalData[0].slice().sort(
        (a,b) =>a.cab - b.cab);
